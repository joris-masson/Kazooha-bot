...
Ainsi réfléchissait le loup en suivant l’intrus à travers la forêt, faisant de son mieux pour ignorer les relents d’alcool qui venaient lui emplir les narines.""",
    2: """Il est bien connu que les loups ont un odorat beaucoup plus développé que les humains. Ce n’est donc pas une surprise si la puanteur des vapeurs d’alcool émanant de l’homme paraissait particulièrement nauséabonde au loup, qui sentit les larmes lui monter aux yeux.
...
Puis il entreprit de narrer son histoire.""",
    3: """La légende raconte l’histoire de ce loup qui errait, solitaire, sur des terres éloignées.
