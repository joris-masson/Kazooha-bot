artifact = {
    1: """__**Fleur de l'Aventurier**__
	*Une fleur qui a su survivre à l'environnement hostile d'une cité antique. Elle est désormais portée avec fierté, comme une médaille.*
    ...
    2: """__**Plume de queue de l'Aventurier**__
	*Une plume d'un oiseau exotique rarement vu sur le continent.*
    ...
    3: """__**Montre de poche de l'Aventurier**__
	*Les aventuriers oublient souvent la notion du temps lorsqu'ils s'aventurent dans des profondeurs obscures ou des ruines oubliées.*
    ...
    4: """__**Coupe en or de l'Aventurier**__
	*Il s'agit certainement du trophée obtenu à l'issue d'une aventure. Un bel objet, bien que légèrement endommagé.*

	Une ancienne coupe dorée utilisée par l'aventurier pour boire. Il l'aurait trouvée dans d'anciennes ruines.
    ...
    5: """__**Bandeau de l'Aventurier**__
	*Un bout de tissu qu'on enroule autour du front. Bien qu'il soit plein de poussière et de sueur, il continue d'être la fierté de l'aventurier.*
