artifact = {
    1: """__**Fleur de fer ensanglantée**__
	*Une fleur séchée imprégnée de sang, qui a fini par devenir aussi dure que le fer. Probablement un genre de souvenir pour son ancien propriétaire.*
    ...
    2: """__**Plume noire ensanglantée**__
	*Une plume d'un manteau de chevalier. D'innombrables taches de sang ont fini par la teindre en noir.*
    ...
    3: """__**Sablier du Chevalier ensanglanté**__
	*Un sablier ayant appartenu autrefois à un chevalier. Le liquide qu'il contient a séché depuis longtemps, le rendant inutilisable.*
    ...
    4: """__**Coupe du chevalier ensanglantée**__
	*Une coupe ayant appartenu au Chevalier ensanglanté. Le sang séché et la fumée l'ont complètement noircie.*
    ...
    5: """__**Masque de fer ensanglanté**__
	*Un masque de fer protégeant autrefois le visage d'un certain chevalier. Nombreuses furent les spéculations quant à qui se cachait derrière.*
