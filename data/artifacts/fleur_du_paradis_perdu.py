artifact = {
    1: """__**Myriade d'Ay-Khanoum**__
	*À une époque révolue dont seules les djinns se souviennent, la reine des fleurs fut abandonnée par les cieux.
...
En cet endroit où elle arrêta ses pas, une magnifique fleur violette aussi belle que la lune était en train d'éclore. Elle portait le nom de « padisachidée ».""",
    2: """__**Fête du flétrissement**__
	*Une plume laissée par une espèce d'oiseau disparue depuis longtemps. Elle a été incrustée d'or et de pierres précieuses par les anciens adeptes de la Déesse des fleurs.*
	
	À une époque révolue que seules les djinns pleurent, la reine des oasis prit sa dernière décision.
...
De la même manière que ce roi-dieu obstiné a orchestré cette rébellion secrète, survivant par la seule force de sa volonté.
...
« Ce que l'on appelle une « divinité » n'est-il pas pour vous quelque chose de superflu depuis le début ? »""",
    3: """__**Instant figé**__
	*Ces sables ne bougent plus, peu importe la façon dont vous inclinez le sablier, défiant maintenant et pour toujours la dérive du temps lui-même.*
	
	À une époque révolue qui provoque les soupirs des djinns, le roi des sables écarlates construisit un mausolée pour sa bien-aimée.
Avec les pierres précieuses enfouies sous les sables profonds comme source d'énergie et grâce à l'aide des djinns, il bâtit une oasis éternelle.
...
Et ces tribus sans racines, quant à elles, suivent le déplacement des dunes et continuent leur cycle de vie et de mort...""",
    4: """__**Bouteille magique du gardien du secret**__
	*Un petit flacon en cristal violet. Un capuchon émeraude le maintient hermétiquement fermé.*
	
	À une époque révolue que les djinns refusent de mentionner, le seigneur des sables fit part de son ambition à la reine des fleurs...
...
Le roi Deshret revint des sables tourbillonnants qui consumaient les cieux, tandis que la reine des fleurs avait disparu sans laisser de traces.
...
« ... J'ai rêvé de toi... Tu cherchais ton chemin à travers les murs du labyrinthe de cristal... Tout ce que tu voyais... n'était que du sable... »""",
    5: """__**Couronne d'améthyste**__
	*Une couronne incrustée d'améthyste et d'émeraude. Elle semble avoir été le couvre-chef porté par les anciens prêtres de la Déesse des fleurs.*
	
	À une époque révolue que seules les djinns chantent, la maîtresse des oasis fit la rencontre du roi des sables écarlates.
