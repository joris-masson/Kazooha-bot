artifact = {
    1: """__**Détermination du Marcheur du feu**__
	*Une fleur qui s'est épanouie au milieu des flammes. Selon la légende, les sages des temps anciens la portaient sur eux avant de traverser la mer de feu.*
...
Le Marcheur du feu était introuvable, mais ils virent les fleurs s'épanouir dans les cendres.""",
    2: """__**Insouciance du Marcheur du feu**__
	*Une plume de phénix. On peut presque entendre le battement des ailes au milieu des flammes.*
...
Nul ne savait s'il s'agissait du cri de l'oiseau ou d'un signe de vie du Marcheur du feu.""",
    3: """__**Tourment du Marcheur du feu**__
	*Un sablier aux grains scintillants de sable brûlant. Le sable ne laisse aucune trace lorsqu'il s'écoule.*
...
Être délaissé par ses élèves et ses proches étaient les flammes amères auxquelles il succomba.""",
    4: """__**Éveil du Marcheur du feu**__
	*Les légendes disent que cette coupe pouvait contenir de la lave. Elle est vide aujourd'hui, mais continue d'émettre une certaine chaleur.*
...
Elle était emplie de fierté avant le départ du Marcheur du feu pour son dernier voyage.""",
    5: """__**Sagesse du Marcheur du feu**__
	*La couronne de sagesse de quelqu'un qui traversa le feu. Elle brillait jadis à la lueur des flammes.*
