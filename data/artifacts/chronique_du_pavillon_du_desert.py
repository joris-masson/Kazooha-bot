artifact = {
    1: """__**Aube de la cité des rois**__
	*Une fleur artificielle qui brille d'une lumière étrange. Si vous y tendez l'oreille, vous entendrez légèrement un rire enchanteur à l'intérieur.*
	
	Noble déchu, écoutez les paroles du vieil homme aveugle que je suis.
...
Les enseignements d'hier, enfouis sous les sables mouvants dorés, se répéteraient demain avec le vent sans fin du temps, encore et encore...""",
    2: """__**Fin du royaume doré**__
	*Une plume artificielle cristalline qui est l'un des héritages d'un ancien royaume humain. Les cris d'aigles en plein essor sont également scellés à l'intérieur.*
	
	Jeunes vagabonds, écoutez les paroles du vieil homme aveugle que je suis.
...
Pendant ce temps, la meule du destin continue de tourner, dispersant les espoirs brisés à travers le monde.""",
    3: """__**Horloge du chemin perdu**__
	*Une ancienne horloge mécanique. Les fragments de protection des esprits continuent d'émettre de la lumière en son centre et vibrent très légèrement, comme pour dire quelque chose...*
...
« Enfin, nous retournerons dans l'étreinte de notre créatrice innocente et tourmentée, Shirin... »""",
    4: """__**Défenseur du rêve enchanteur**__
	*Une ancienne coupe dorée à la fois merveilleusement et luxueusement travaillée. Des murmures peuvent être entendus de ses entrailles vides...*
	
	Voyageurs, vous qui venez boire à l'oasis, écoutez les paroles du vieil homme aveugle que je suis.
...
Le roi Deshret cherchait vainement les traces de l'ancien paradis à l'endroit où les clous divins étaient tombés, afin d'y ériger une oasis éternelle...
...
« Même moi, qui ai été abandonnée par une destinée aussi imprévisible que les dunes, j'ai le droit d'attendre un changement du destin ? »""",
    5: """__**Héritage de la haute lignée du désert**__
	*Des boucles d'oreilles en or ambre qui brillent d'une étrange lumière.*
	
	Vous, marchands qui vous abritez de la tempête, pourquoi ne pas écouter les paroles du vieil homme aveugle que je suis ?
