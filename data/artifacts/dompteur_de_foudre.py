artifact = {
    1: """__**Cœur du Dompteur de foudre**__
	*Une fleur qui pousse uniquement dans des zones orageuses. Elle donne le courage de s'aventurer dehors lorsque la tempête fait rage.*
    ...
    2: """__**Plume du Dompteur de foudre**__
	*La plume d'un oiseau de proie ayant traversé les orages. On raconte qu'il s'agit là de l'insigne qu'adopta le héros qui pacifia l'éclair et le tonnerre.*
    ...
    3: """__**Temps du Dompteur de foudre**__
	*Le sablier du héros qui conquit l'éclair et le tonnerre. Les éclats cristallins de foudre s'écoulent avec le temps.*
    ...
    4: """__**Calice du Dompteur de foudre**__
	*Le calice à vin dans lequel le Dompteur de foudre, qui vint à bout de la bête de foudre, but des éclairs pourpres.*
    ...
    5: """__**Couronne du Dompteur de foudre**__
	*Le diadème que le Dompteur de foudre reçut après avoir vaincu le monstre de tonnerre qui menaçait le pays.*
