artifact = {
    1: """__**Rose du Berserker**__
	*Une délicate rose teintée en rouge qui représente l'essence même d'un Berserker.*
    ...
    2: """__**Plume du Berserker**__
	*Une plume noire appartenant à un légendaire oiseau messager de la mort qui a été teintée en rouge.*
    ...
    3: """__**Sablier du Berserker**__
	*Le liquide à l'intérieur s'écoule sans merci. Il indique le temps qu'il nous reste sur le champ de bataille et au sein de ce monde.*
    ...
    4: """__**Coupe du Berserker**__
	*Une coupe taillée dans l'os d'un animal inconnu dont la chasse a été rude.*
    ...
    5: """__**Masque du Berserker**__
	*Un masque en fer endommagé lors des combats entre son porteur et ses ennemis.*
