artifact = {
    1: """__**Fleur odysséenne**__
	*Toute histoire doit se terminer, et même les fleurs fraîches se faneront. Mais la fleur dans nos rêves restera toujours en pleine floraison parfumée...*

	... Au bout du compte, les ténèbres planèrent tout de même sur le royaume.
...
Elles se remémoraient sans cesse les aventures de l'après-midi qui n'avaient pas continué... """,
    2: """__**Plumule de mage malsain**__
	*C'était autrefois une plume décorative dans le chapeau de quelqu'un. D'un vert foncé, elle attire plutôt l'œil.*

	Les héros et les chevaliers s'opposaient toujours aux mages et aux dragons maléfiques.
...
héros, mages, chevaliers et dragons fixaient toujours du regard une plume d'une espèce d'oiseau inconnu, accrochée sur le chapeau de la directrice adjointe.
Cette plume contenait certainement d'innombrables récits, d'après ces petits aventuriers.
La directrice adjointe devait avoir vu beaucoup d'histoires, comme une vieille héroïne après sa réclusion.
...
La directrice adjointe eut un instant de réflexion et décrocha la plume vert foncé de son chapeau avant de partir.
...
Elle accompagna son nouveau propriétaire jusqu'à la source du fléau de la séparation avant de revenir en arrière... """,
    3: """__**Constance de la nymphe**__
	*Une montre de poche qui a depuis longtemps cessé de fonctionner. Elle semble avoir été le témoin de nombreuses années passées alors que ses aiguilles tournaient en vain.*

	Les aiguilles d'une horloge reviendront à leur place originelle pour renouveler le cycle.
...
« Des amis... Je pense à quelqu'un dont le nom ferait l'affaire. » """,
    4: """__**Goûter des héros**__
	*Une magnifique tasse à thé. Peut-être était-elle autrefois utilisée par des personnes profitant d'un après-midi tranquille ensemble...*

	Les champions de Narzissen avaient également besoin de se reposer un peu au milieu de leur route.
...
Pourquoi ? Tout simplement parce que le goûter que préparait la directrice adjointe était un véritable délice.
...
Ses vêtements se retrouvèrent mouillés en conséquence. La directrice adjointe était assez âgée pour être la mère de cette petite fille.
...
La petite fille appréciait la situation. De plus, le goûter était délicieux. """,
    5: """__**Monocle de dragon démoniaque**__
	*Un monocle de fabrication exquise. D'anciens potins disent même qu'on pourrait voir l'avenir à travers ce dernier...*

	Les héros de chaque histoire trouvaient chacun leur propre épée sainte (temporaire) et affrontaient différents ennemis.
...
« Les bêtes étoilées s'abreuveront de tout le liquide amniotique du monde. Dans une centaine d'années, toute vie sur sa surface disparaîtra. »
