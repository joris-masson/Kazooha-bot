artifact = {
    1: """__**Anémone du Médecin itinérant**__
	*Un ingrédient rare qui a perdu toute vertu médicinale après des années de stockage.*
    ...
    2: """__**Plume de hibou du Médecin itinérant**__
	*Une plume rigide de hibou. Elle procure encouragement et motivation au docteur devant visiter ses patients la nuit.*
    ...
    3: """__**Montre de poche du Médecin itinérant**__
	*Une montre très précise. Pour les médecins, chaque seconde compte.*
    ...
    4: """__**Pot à remèdes du Médecin itinérant**__
	*Un pot autrefois rempli d'un remède très concentré, dont il ne reste aujourd'hui plus que l'odeur.*
    ...
    5: """__**Mouchoir du Médecin itinérant**__
	*Un mouchoir utilisé lors des opérations pour s'attacher les cheveux, qui peut aussi servir de bandage pour une entorse ou un bras cassé en cas d'urgence.*
