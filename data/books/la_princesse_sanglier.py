...
(Quelques mots ont été gribouillés sur le côté de la page : « Baba, si je mange pa de bonbon tout lé soir et que je pri tout lé jour, est ce que je seré un cochon sovage un jour ? Je veut etre un cochon sovage, ils sont si délissieu. »)""",
    ...
    2: """Au nord du territoire des sangliers se trouvait une toundra gelée.
...
« Brrrrr… Il fait si froid ! Mes griffes vont geler sin. place ! »
...
(Quelques mots ont été gribouillés sur le bas de la page: « Baba, pourquoi le louvetau n’a pa les papattes froide ? »)""",
    ...
    3: """Le louveteau était autrefois un enfant libre et insouciant, aux yeux bleus et au joli pelage de couleur grise.
...
« Cri-cri ! Quel toupet ! Je transpercerai son cœur avec la plus froide des glaces ! Jamais plus il ne connaitra l’espoir ! »
...
Furieux, le sorcier se mit à hurler les pires injures qu’il avait pu prononcer de sa vie d’écureuil. Sentant les cris remonter dans sa gorge, le louveteau réalisa son erreur.
...
(Une note manuscrite d’écriture soignée collée à cette page : « Voilà pourquoi il faut faire attention à ce que tu manges quand tu joues dehors, Lili. »)""",

    4: """Et ainsi, sans que nul ne sut ce qu’il se passa dans l’estomac du louveteau, la malédiction du sorcier se réalisa !
...
(Quelques mots ont été écrits par une petite fille sur le coin de la page: « Baba, il es partie ou Woobaka ? »)""",
    ...
    5: """Un beau jour, la princesse sanglier entendit parler du louveteau.
...
(Une note rédigée par le père de la petite fille a été collée à la page : « Les tortues n’ont pas de cri ; le grand-père tortue, qui est très poli, a pris la peine de l’expliquer. »)""",
    ...
    6: """Ainsi, la princesse et les deux sages partirent pour les montagnes gelées du nord. Partout, tout n’était que glace et neige. Le plus courageux des guerriers, le plus fort des animaux ou la plus débrouillarde des belettes n’aurait pu trouver un bourgeon tendre ou un fruit juteux dans cette région inhospitalière.
...
« Oui, oui, princesse ! Il neige de plus en plus fort… Et ce vent est glacial…
Arrêtons-nous, nous continuerons quand le ciel sera dégagé ! Pardon, je ne peux pas crier. »
...
« Groin-groin ! Êtes-vous le maitre des lieux ? Pourriez-vous nous aider à traverser ce blizzard ? »,
...
Et ainsi, l’esprit se transforma en un courant de glace, grâce auquel la princesse déterminée put traverser les hautes montagnes enneigées…""",
    ...
    7: """Après avoir bravé le froid et la tempête, la princesse rencontra enfin le louveteau.
...
« Snif… Tu… Tu n’as même pas de quoi manger ici, tu finiras par mourir de faim, loup. Je n’ai jamais vu telle misère date mon royaume !
...
Réalisant que l’on partait de lui, le renard voulut fuir à pattes raccourcies ; mais le louveteau et la princesse eurent tôt fait de le rattraper. Quant à la sage tortue, elle s’empressa de rentrer dans sa carapace, terrifiée comme de juste.
Le louveteau et la princesse sanglier purent alors profiter d’un copieux repas à base de renard dans la neige ; suite à quoi, ils confectionnèrent une délicieuse soupe à la tortue à
l’aide de champignons ramassés dans une grotte proche.
