...
La Forêt du Clair de Lune était le seul endroit à avoir échappé à la Mère de la Nuit.
Seulement en ce lieu pouvaient les hommes voir la clarté de la lune, qui y octroyait ses faveurs au peuple. Les habitants de ce royaume avaient le teint et les cheveux clairs, et des yeux d’un bleu léger venaient compléter une délicate apparence. Entièrement isolés du soleil durant de longues années, c’était grâce à la lueur de la lune qu’ils différaient des répugnantes et sombres créatures peuplant le monde extérieur.""",
    2: """Un conte traditionnel populaire en Teyvat. Ce deuxième tome se focalise sur la rencontre de la Princesse Neige et du prince.""",
    3: """Un conte traditionnel populaire en Teyvat. Dans ce troisième tome, la Princesse Neige et le prince décident de sauver la Forêt du Clair de Lune.""",
    4: """Un conte traditionnel populaire en Teyvat. Dans ce quatrième tome, la Princesse Neige et le prince rencontre les six nains.""",
    5: """Un conte traditionnel populaire en Teyvat. Dans ce cinquième tome, nous en apprenons davantage sur le plan machiavélique des six nains.""",
    6: """Un conte traditionnel populaire en Teyvat. Dans ce sixième tome, les six nains élaborent l’exécution de leur plan.""",
    7: """Un conte traditionnel populaire en Teyvat qui touche à sa fin dans ce tome."""
}
