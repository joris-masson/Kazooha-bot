...
En grandissant, le garçon finit par ne plus croire aux histoires des anciens. Suivant le chemin laissé par les fées, il traversa le labyrinthe vert, accompagné de temps en temps par le cri des renards cachés dans les fourrés. Il est rare que ces créatures rusées se révèlent aux hommes – il est encore plus rare de voir l’une de leurs processions.
...
Est-ce que les inamovibles Monts Qingce étaient le don de l’Archon ? A moins qu’il ne s’agisse de la paix ayant béni des générations d’habitants ?
...
Et c’est ainsi que le jeune garçon avait entrepris de traverser la forêt de bambous.""",
    2: """Perdu au milieu de la canopée de bambous verts, le garçon fit bientôt la connaissance d’un compagnon inattendu.
...
Le soleil finit par disparaitre derrière la montagne, et les dernières lueurs du jour laissèrent progressivement la place à l’obscurité.
...
Les trois saurs partageaient la même affection pour les étoiles du matin, tout comme elles partageaient la même affection l’une envers l’autre. Tout cela remonte à une époque où le monde n’avait pas encore été victime de la calamité à venir.
...
« Avant même que l’univers ne soit instauré par les puissants immortels, des dieux errants parcourraient les terres. C’est à cette époque que les Adeptes prirent vie. Mais qu’y avait-il avant cet âge ? Seulement des souvenirs, des fragments du temps passé devenus histoires, puis légende, transmises de génération en génération…
...
Cette nuit-là, le garçon vit en rêve trois lunes dans le ciel, et un carrosse argenté s’arrêtant devant les étoiles.""",
    ...
    5: """Il fut doucement tiré de son sommeil par la lumière du jour pointant.
...
Dans la brume matinale, le garçon entendit un cri strident qui disparut au loin. Se retournant, il n’aperçut aucune âme qui vive, mais découvrit un cheveu posé délicatement sur son épaule."""
}
