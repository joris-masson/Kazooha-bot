...
(Dongtang, appagionnato)
Zixin : Qu’il est dur de travailler chaque jouir sous la lumière des étoiles, du soleil et de la lune… Le riche connaît le confort, quand le pauvre doit se battre. La vie est ainsi faite.
...
(Dongtang, straziànte)
Zixin : Poisson frais ! Il est fraissnon poisson !
(Entre Mamie Zhang, porteuse d’un panier de fleurs)
(Sprechstimme)
Mamie Zhang : Regardez ces poissons ! (les poissons s’agitent et éclaboussent Mamie Zhang) Quelle énergie ! Voilà qui fera une souipe de premier choix !
Mamie Zhang : Regardez-moi, trempée des pieds à la tête. Ne ressemblé-je pas à quelque jouvencelle aux joues roses et aux lèvres écarlate ?
(À part).
...
(Dorigtang, andante calmo)
Fanjie : Voilà qui est de bon augure ! Se promener et voir apparaitre ces perles…
(À part)
Fanjie : Je m’appelle Fanjie et je travaille sur le quai. Mes frères m’ont choisi comme chef. Fanjie : Le bracelet que j’ai trouvé doit appartenir à cette jeune fille.
...
Zixin : Mes poissons sont frais, je peux vous l’assurer. Libre à vous de les cuire comme il vous plait.
Fanjie : Ces poissons n’arrêtent pas de bouger, quelle vivacité, vraiment.
Fanjie : Approchez-vous, et faisons connaissance.
(Zixin avance)
Farijie : Ainsi donc ces perles reviennent à une demoiselle d’une grande beauté. Voilà qui est adapté.
...
Fanjie : Moi, Fanjie, j’ai toujours fait ce qui était juste, de telle choses me répulsent.
N’essayez pas de m’accuser à tort.
...
Mamie Zhang : Ces mesdames et messieurs du public sont là pour voir Yunjin jouer, et n’ont que faire de vos absurdités.
...
Ensemble : Que le désir de mon coeur devienne réalité.
...
Fanjie : Demoiselle Zixin, je prends congé.
...
(Wu Wang, Wu Yi et Wu Er quittent la scène, emmenant Zixin)""",
    ...
    (Entre Mamie Zhang)
(À part)
Mamie Zhang : Vénérable audience, si vous avez bien écouté les pièces de Yunjin et que vous connaissez les ficelles de l’art, vous avez peut-être par chance deviné la suite de l’histoire.
...
Fanjie : Je ne puis la laisser aux mains de ce bandit !
...
(Fan Jie saute par-dessus le mur et quitte la scène)
(Piangevole)
...
(À part) Zi Xin : Je ne vous appartiendrai jamais !
(Wu Wang poursuit Zi Xin, qui le frappe avec le chandelier. Wu Wang chute. Zi Xin s’écroule de soulagement.)
(Dongtang, andante calmo)
Zi Xin : Dans l’infortune la chance me sourit ! Le pied mal assuré, je fuis.
(À part)
Zi Xin : Aucune lumière à l’extérieur, pourquoi une telle obscurité ?
Zi Xin : Et si j’allumais ce chandelier…
Zi Xin : Un instant. Si je me fais reprendre, je serai en danger.
Zi Xin : Mieux vaut ne point l’allumer, et chercher dans le noir le chemin de la liberté.
Zi Xin : Oui, voilà qui devrait marcher.""",

    8: """Personnage masculin : Fanjie
Personnage féminin : Zixin
Antagoniste : Wu Wang
...
(Wu Wang marche sur les pieds de Fan Jie dans l’obscurité, les deux font un mouvement de recul)
Wu Wang : Hahaha, alors tu es là !
(Wu Wang ouvre les bras pour s’emparer de Fan Jie, qui l’évite. Les deux trébuchent dans le noir, tandis que Zi Xin se retire dans un coin)
(Wu Wang attrape enfin Fan Jie)
Wu Wang : Hahaha, je t’ai attrapée !
(À part)
Wu Wang : Étrange, tes hanches ont-elles grandi depuis la dernière fois ?
Fan Jie : J’ai mis plus de vêtements, pour me protéger du froid.
Wu Wang : En effet, mieux vaut se couvrir dans ce cas.
Wu Wang : Mais pourquoi cette taille démesurée ?
Fan Jie : Je suis une artiste, je porte des chaussons d’opéra.
Wu Wang : Oh, voilà qui doit être malaisé.
Wu Wang : Et pourquoi ces mains si épaisses ?
Fan Jie : Approchez donc, que je me confesse.
Wu Wang : Me voilà, me voilà.
(Fan Jie transperce Wu Wang de son épée)
Fan Jie : Parce que je manie l’épée, avec laquelle je vais t’achever.
(Wu Wang s’écroule)

Scène 2
(À part)
Fan Jie : Pitoyable. Un coup d’épée aura suffi.
Zi Xin : Fan Jie ? Toi ici ?
Fan Jie : Cette voix… C’est Zi Xin, si je ne me trompe pas !
(Zi Xin, Fan Jie se retrouvent et leurs mains se touchent)
Zi Xin : Fan Jie !
Fan Jie : Tu as dû souffrir.
Fan Jie : Ce vaurien est mort, ne restent que ses sbires.
Fan Jie : La tète est tombée, nul doute qu’ils vont fuir en cohortes.
Fan Jie : N’aie crainte ma mie, je m’occupe de la porte.
(Fan Jie brise la porte)
Zi Xin : Ah, que me serait-il arrivé, sans un héros de la sorte ?
(Dongtang, lento)
Zi Xin : Que les perles de mon cœur reposent en votre demeure.
Fan Jie : Que la brise nous guide en ce monde ici-bas.
Fan Jie : La pâle lune brille sur les catalpas.
Zi Xin : La tête baissée, j’acquiesce – et ainsi naît cette promesse.
— FIN —"""
}
